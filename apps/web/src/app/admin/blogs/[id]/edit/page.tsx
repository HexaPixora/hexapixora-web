    ...
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-muted-foreground">Loading blog post details...</p>
        </div>
      </div>
    );
  }
          ...
          {isPublishedWatch ? (
            <>
              <Button
                ...
                className="text-amber-500 hover:text-amber-600 hover:bg-amber-500/10 border-amber-500/20 rounded-xl"
              >
                Revert to Draft
              </Button>
              <Button
