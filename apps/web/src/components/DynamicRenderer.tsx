...
const SECTION_MAP: Record<string, React.ComponentType<any>> = {
  ...
  OurStoryModule: dynamic(() => import("@/components/modules/our-story-module")),
  OurProcessModule: dynamic(() => import("@/components/modules/our-process-module")),
  WorkHeroModule: dynamic(() => import("@/components/modules/work-hero-module")),
  StoryHeroModule: dynamic(() => import("@/components/modules/story-hero-module")),
  ...
  RichTextModule: dynamic(() => import("@/components/modules/rich-text-module")),
